...
const Icon = {
    ...
    Regalo: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25v13.5m0-13.5a2.625 2.625 0 10-2.625-2.625A2.625 2.625 0 0012 8.25zm0 0a2.625 2.625 0 112.625-2.625A2.625 2.625 0 0112 8.25zm-8.25 3h16.5m-16.5 0v7.5a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5v-7.5m-16.5 0a1.5 1.5 0 011.5-1.5h13.5a1.5 1.5 0 011.5 1.5" />
        </svg>
    ),
    Categorias: (
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const navItems = [
        ...
        { href: route('admin.reviews.index'), active: route().current('admin.reviews.*'), icon: Icon.Resenas, label: 'Reseñas' },
        ...
        { href: route('admin.combos-regalo.index'), active: route().current('admin.combos-regalo.*'), icon: Icon.Regalo, label: 'Combos de Regalo' },
