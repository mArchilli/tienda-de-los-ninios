...
function BulkDeleteModal({ open, onClose, selectedIds, onSuccess }) {
    ...
    const submit = () => {
        setProcessing(true);
        router.delete(route('admin.combos-emprendedor.bulk-destroy'), {
    ...
    return (
        <Modal open={open} onClose={onClose} title="Eliminar combos emprendedor">
            <div className="space-y-4">
                <div className="flex items-start gap-3 rounded-xl bg-red-50 border border-red-100 p-4">
                    <svg className="h-5 w-5 shrink-0 text-red-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" />
                    ...
                    <div>
                        <p className="text-sm font-semibold text-red-700">
                            ¿Eliminar {count} combo{count !== 1 ? 's' : ''} emprendedor?
                        </p>
                        <p className="text-xs text-red-500 mt-1">Esta acción no se puede deshacer.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
                        <h1 className="text-xl font-bold text-brand-text">
                            {selectionMode ? 'Selección' : 'Combos Emprendedor'}
                        </h1>
