        ...
        <Link href={href} className="group block h-full">
            <article className="flex h-full flex-col overflow-hidden bg-white transition duration-300 hover:-translate-y-0.5">
                <div className="relative aspect-[4/5] overflow-hidden bg-white">
                    ...
                    <span className="absolute bottom-3 right-3 flex h-8 w-8 items-center justify-center rounded-full bg-white text-brand-cta shadow-md transition-transform duration-300 group-hover:scale-110">
                ...
                <div className="flex flex-1 flex-col px-2 py-3">
                    <h3 className="line-clamp-2 min-h-[2.4rem] text-[13px] font-extrabold uppercase tracking-[0.04em] text-brand-text">
                        {item.name}
                    </h3>
